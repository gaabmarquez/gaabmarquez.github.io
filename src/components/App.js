  ...
  works: [
    {
      ...
      to: '',
      description: [
        'Development of solutions with React,Redux, HTML, CSS, SASS among others.',
        'Development of re usable components and libraries to improve maintainability.',
        'Maintenance of existing application in Java, Spring, Spring Data & Hibernate.',
        'UI improvements & redesign of existing views in PHP',
        'Maintenance of existing application in NodeJS',
      ],
    },
    {
      id: 1,
